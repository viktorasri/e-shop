    ...
    <Router>
      ...
      <main className='py-3'>
        <Container>
          ...
          <Route exact path='/admin/productslist' component={ProductListScreen} />
          <Route path='/admin/productslist/page/:page' component={ProductListScreen} />
          ...
          <Route path='/search/:query/page/:page' component={HomeScreen} />
