...
export const payOrder = (id, payResults) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.put(`/api/orders/${id}/pay`, payResults, config);
...
export const deliverOrder = (id) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.put(`/api/orders/${id}/delivery`, {}, config);
...
export const getMyOrdersList = () => async (dispatch, getState) => {
  try {
    dispatch({ type: ORDER_MY_ORDERS_LIST_REQUEST });
